...
class GroundedSAMSegmentor:
    """Example adapter placeholder for Grounded-SAM style pipelines.

    This repository does NOT bundle model weights/inference code for
    https://github.com/idea-research/grounded-segment-anything.
    Implement `infer` by wiring your own detector + segmentor stack.
    """

    def infer(self, rgb: np.ndarray, depth: np.ndarray) -> Tuple[np.ndarray, np.ndarray, Optional[str]]:
        raise NotImplementedError(
            "GroundedSAMSegmentor is an interface placeholder. "
            "Please integrate your own Grounded-SAM / SAM2 / OWLv2+SAM pipeline."
        )
